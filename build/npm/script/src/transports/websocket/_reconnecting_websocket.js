...
class ReconnectingWebSocket {
    ...
    _createSocket(url, protocols) {
        try {
            const socket = (0, _websocket_factory_js_1.createCompatibleWebSocketSync)(url, protocols);
            ...
            if (error instanceof _websocket_factory_js_1.WebSocketCompatibilityError) {

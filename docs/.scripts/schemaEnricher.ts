/**
 * Enriches JSON Schema with descriptions extracted from JSDoc comments.
 *
 * Takes a JSON Schema generated by valibot-to-json-schema and adds description
 * fields from parsed JSDoc data, recursively handling nested objects, arrays,
 ...
 *
 * const jsonSchema = { type: "object", properties: { user: { type: "string" } } } as const;
 * const enriched = enrichJsonSchema(jsonSchema, { fields: { "user": "User address" } });
 * // Returns schema with description added to the "user" property
 * ```
 */
...
/** JSON Schema node - can be boolean or object with schema properties */
type JsonSchemaNode = boolean | JsonSchemaObject;

/** JSON Schema object with optional properties for enrichment */
...
function enrichSchemaNode(
  ...
  // Skip boolean schemas (true/false)

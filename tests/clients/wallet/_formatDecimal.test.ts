...
Deno.test("_formatDecimal", () => {
    assertEquals(
        ...
        new WalletClient({})._formatDecimal("123.0"),
        "123",
    ...
    assertEquals(
        // @ts-ignore - Accessing private method
        new WalletClient({})._formatDecimal("123."),
        "123",
    ...
    assertEquals(
        // @ts-ignore - Accessing private method
        new WalletClient({})._formatDecimal("0.1230"),
        "0.123",
    ...
    assertEquals(
        // @ts-ignore - Accessing private method
        new WalletClient({})._formatDecimal("456"),
        "456",
    ...
    assertEquals(
        // @ts-ignore - Accessing private method
        new WalletClient({})._formatDecimal("78.901"),
        "78.901",

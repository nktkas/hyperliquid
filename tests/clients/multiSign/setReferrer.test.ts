...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["setReferrer"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("setReferrer", { ignore: !PRIVATE_KEY }, async () => {
    ...
    await multiSignClient.setReferrer({ code: "TEST" })
        .then((data) => {

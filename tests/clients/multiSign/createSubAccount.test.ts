...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["createSubAccount"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("createSubAccount", { ignore: !PRIVATE_KEY }, async () => {
    ...
    await multiSignClient.createSubAccount({ name: String(Date.now()) })
        .then((data) => {

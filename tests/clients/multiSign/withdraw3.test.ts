...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["withdraw3"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("withdraw3", { ignore: !PRIVATE_KEY }, async () => {
    ...
    const data = await multiSignClient.withdraw3({
        amount: "2",
        destination: MULTI_SIGN_ADDRESS,
    });

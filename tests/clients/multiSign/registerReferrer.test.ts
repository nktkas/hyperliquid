...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["registerReferrer"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("registerReferrer", { ignore: !PRIVATE_KEY }, async () => {
    ...
    await multiSignClient.registerReferrer({ code: "TEST" })
        .then((data) => {

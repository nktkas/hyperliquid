...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["cancel"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("cancel", { ignore: !PRIVATE_KEY }, async () => {
    ...
    const data = await Promise.all([
        ...
        multiSignClient.cancel({
            cancels: [{
                a: id,
                o: await openOrder(multiSignClient, id, pxDown, sz),
            }],
        }),

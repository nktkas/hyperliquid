...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["cDeposit"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("cDeposit", { ignore: !PRIVATE_KEY }, async () => {
    ...
    const data = await multiSignClient.cDeposit({ wei: 1 });

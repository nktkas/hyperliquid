...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["createVault"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("createVault", { ignore: !PRIVATE_KEY }, async () => {
    ...
    await multiSignClient.createVault({ name: "", description: "", initialUsd: 50 * 1e6 })
        .then((data) => {

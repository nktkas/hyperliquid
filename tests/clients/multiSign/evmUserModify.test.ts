...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["evmUserModify"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("evmUserModify", { ignore: !PRIVATE_KEY }, async () => {
    ...
    const data = await Promise.all([
        ...
        multiSignClient.evmUserModify({ usingBigBlocks: true }),
        multiSignClient.evmUserModify({ usingBigBlocks: false }),
    ]);

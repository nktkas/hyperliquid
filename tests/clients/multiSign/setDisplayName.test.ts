...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["setDisplayName"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("setDisplayName", { ignore: !PRIVATE_KEY }, async () => {
    ...
    const data = await multiSignClient.setDisplayName({ displayName: "" });

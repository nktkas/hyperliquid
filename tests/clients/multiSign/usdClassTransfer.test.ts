...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["usdClassTransfer"]>>;
...
Deno.test("usdClassTransfer", { ignore: !PRIVATE_KEY }, async () => {
    ...
    const data = await Promise.all([
        ...
        multiSignClient.usdClassTransfer({ amount: "1", toPerp: false }),
        multiSignClient.usdClassTransfer({ amount: "1", toPerp: true }),
    ]);

...
export type MethodReturnType = Awaited<ReturnType<MultiSignClient["cWithdraw"]>>;
const MethodReturnType = schemaGenerator(import.meta.url, "MethodReturnType");

// —————————— Test ——————————

Deno.test("cWithdraw", { ignore: !PRIVATE_KEY }, async () => {
    ...
    const data = await multiSignClient.cWithdraw({ wei: 1 });

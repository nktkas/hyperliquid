...
runTest({
  ...
  codeTestFn: async (_t, client) => {
    ...
    schemaCoverage(SubAccounts2Response, data, [
      "#/wrapped/items/properties/dexToClearinghouseState/items/items/1/properties/assetPositions/items/properties/position/properties/leverage/variant/0",
      "#/wrapped/items/properties/dexToClearinghouseState/items/items/1/properties/assetPositions/items/properties/position/properties/liquidationPx/defined",
